...
{
    public partial class GenerateSin : Form
    {
        ...
        public static Bitmap ControlImg= new Bitmap(200,200);

        #endregion



        public GenerateSin(MainForm mainForm)
        {
            try
            {
        ...
        private void GenerateSin_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void GenerateSin_Load(object sender, EventArgs e)
        {
            Signal.Wave = Convert.ToInt32(textBox5.Text);
            Signal.Faze = Convert.ToInt32(textBox1.Text);
